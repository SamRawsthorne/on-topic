...
def word_intrusion_task(savefolder, model_name, client, top_n, bottom_n, common_n, chunk_size=10,
                           gpt_model="gpt-4o", temperature=0):
    # Get the topic-word matrix

    model, textbeforetokenization, tokenized_text, corpus, id2word = load_lda_run(savefolder,model_name)
