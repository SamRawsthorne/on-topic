...
def IDXtopics2keep(savefolder,model_name):
    """
    ...
    """
    lda_model, textbeforetokenization, tokenized_text, corpus, id2word = load_lda_run(savefolder,model_name)
...
def diversity(savefolder,model_name):
    """
...
def granularity(savefolder,model_name):
    """
...
def perplexity(savefolder,model_name):
    lda_model, textbeforetokenization, tokenized_text, corpus, id2word = load_lda_run(savefolder,model_name)
    ...
    if model_name.split('_')[0] == 'mallet':
...
def coherence(savefolder,model_name):
    lda_model, textbeforetokenization, tokenized_text, corpus, id2word = load_lda_run(savefolder,model_name)
